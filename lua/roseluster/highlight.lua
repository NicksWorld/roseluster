...
local highlight = function(theme, color)
    return {
        ...
        require("roseluster.plugin.cmp")(theme),
        require("roseluster.plugin.flash")(theme),
        require("roseluster.plugin.git-gutter")(theme),
        require("roseluster.plugin.git-signs")(theme),
        require("roseluster.plugin.lazy")(theme),
        require("roseluster.plugin.lightbulb")(theme),
        require("roseluster.plugin.lsp-config")(theme),
        require("roseluster.plugin.mason")(theme),
        require("roseluster.plugin.oil")(theme),
        require("roseluster.plugin.rainbow-delimiter")(theme),
        require("roseluster.plugin.telescope")(theme),
        require("roseluster.plugin.todo-comments")(theme),
        require("roseluster.plugin.tree")(theme),
        require("roseluster.plugin.trouble")(theme),
        require("roseluster.plugin.which-key")(theme),
        require("roseluster.plugin.notify")(theme),
        require("roseluster.plugin.navic")(theme),
        require("roseluster.plugin.yanky")(theme),
        require("roseluster.plugin.headlines")(theme),
        require("roseluster.plugin.noice")(theme),
        require("roseluster.plugin.dashboard")(theme),
        require("roseluster.plugin.scrollbar")(theme),
        require("roseluster.plugin.bufferline")(theme),
        require("roseluster.plugin.indentmini")(theme),
        -- TODO: decide if each individual mini plugin should be opt in
        -- can wait until all are supported before deciding
        require("roseluster.plugin.mini")(theme),
    }
end
