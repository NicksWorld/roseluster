local lackluster_color = require("roseluster.color")
local lackluster_tweak = require("roseluster.tweak")
...
M.lackluster_reload = function(opt)
    ...
    plenary_reload.reload_module("roseluster")
    require("roseluster").load(opt)
    if opt.theme then
